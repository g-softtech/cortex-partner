  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50">
      ...
      <main className="flex-1 container px-4 md:px-6 max-w-2xl mx-auto py-24 text-center">
        <div className="bg-white p-12 rounded-lg shadow-sm border space-y-6 flex flex-col items-center">
          ...
          <div className="p-4 bg-slate-50 rounded-md border text-sm text-slate-600 max-w-md mx-auto">
            You can expect to hear from us via email within the next 48 hours.
          </div>
          <div className="pt-6">
            <Link
              href="/"
              className="inline-flex h-10 items-center justify-center rounded-md border border-slate-300 bg-white px-8 text-sm font-medium shadow-sm hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950"
            >
              Return Home
            </Link>
          </div>
