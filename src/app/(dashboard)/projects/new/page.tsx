  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <div>
        ...
        <h1 className="mt-4 text-2xl font-bold text-slate-900">Submit New Project</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className="mt-1 block w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm placeholder-slate-400 focus:border-slate-500 focus:outline-none focus:ring-1 focus:ring-slate-500 disabled:bg-slate-50"
          ...
          <div>
            ...
            <textarea
              ...
              className="block w-full rounded-md border border-slate-300 px-3 py-2 text-sm placeholder-slate-400 focus:border-slate-500 focus:outline-none focus:ring-1 focus:ring-slate-500 disabled:bg-slate-50"
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                type="text"
                {...register("budget")}
                className="mt-1 block w-full rounded-md border border-slate-300 px-3 py-2 text-sm placeholder-slate-400 focus:border-slate-500 focus:outline-none focus:ring-1 focus:ring-slate-500 disabled:bg-slate-50"
