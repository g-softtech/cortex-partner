        ...
        {isReportingIssue ? (
          <div className="space-y-4">
            <textarea
              ...
              className="mt-1 block w-full rounded-md border border-slate-300 px-3 py-2 text-sm placeholder-slate-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 min-h-[120px] bg-white"
              disabled={isLoading}
            />
            <div className="flex gap-3">
              ...
              <button 
                ...
                disabled={isLoading}
                className="rounded-md bg-white border border-slate-300 px-5 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 disabled:opacity-50"
              >
                Cancel
              </button>
            </div>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button 
              className="rounded-md bg-white border border-red-200 px-5 py-2 text-sm font-semibold text-red-700 hover:bg-red-50 hover:text-red-800 disabled:opacity-50"
